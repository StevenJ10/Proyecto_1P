...
public class Modulo_Impuestos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Bg_SelectorImpLayout.setVerticalGroup(
            ...
            .addGroup(Bg_SelectorImpLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Btn_Impuestos, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );

        Btn_Impuestos.getAccessibleContext().setAccessibleDescription("");

        Background_Main.add(Bg_SelectorImp, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 0, -1, -1));
